...
# z_all <- sum(z$fatalities,na.rm=TRUE)
# z_year <- ddply(z,.(YEAR),summarise,fatalities=sum(fatalities,na.rm=TRUE)) 
# z_type <- ddply(z,.(EVENT_TYPE),summarise,fatalities=sum(fatalities, na.rm=TRUE)) 
```
